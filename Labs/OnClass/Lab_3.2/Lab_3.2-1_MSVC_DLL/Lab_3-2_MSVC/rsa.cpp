...
extern "C"
{
	...
	DLL_EXPORT void RSAdecrypt(const char* format, const char* privateKeyFile, const char* CipherFile, const char* PlaintextFile);
}
// C/C++ libraries
#include <iostream>
using std::cerr;
...
// Function to load a private key from PEM format
